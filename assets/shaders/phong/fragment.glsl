...
void main()
{
    ...
    vec3 diffuse_component = diffuse_intensity * light.diffuse;
    ...
    vec3 specular_component = specular_intensity * light.specular;

    frag_color = vec4(light.ambient + diffuse_component + specular_component, 1.0);
}